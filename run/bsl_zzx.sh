...
python /mnt/zhangrengang/workspace/myMFP/src/bsl_zzx.py \
  ...
  --train_data_path /home/zhangrengang/Doc/release_features_${train_start_month}-${test_end_month}/train_data_zzx \
  --test_data_path /home/zhangrengang/Doc/release_features_${train_start_month}-${test_end_month}/test_data \
  --ticket_path /home/zhaozexi/SmartHW-main/sample_data/ticket.csv \
  --output_file /mnt/zhangrengang/workspace/myMFP/output/submission_1.cs \
