...
python /mnt/zhangrengang/workspace/myMFP/src/bsl_transformer_zrg.py \
  ...
  --feature_path /mnt/zhangrengang/data/dump/feature \
  --train_data_path /mnt/zhangrengang/data/sample_data/train_data \
  --test_data_path /mnt/zhangrengang/data/sample_data/test_data \
