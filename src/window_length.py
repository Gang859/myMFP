...
window_feature_dir = "/backup/home/zhangrengang/workspace/Doc/win30m_feature_with_ecc_typeA/"
...
if __name__ == "__main__":
    ...
    df.to_csv("/mnt/zhangrengang/workspace/myMFP/output/neg_window_length.csv")
